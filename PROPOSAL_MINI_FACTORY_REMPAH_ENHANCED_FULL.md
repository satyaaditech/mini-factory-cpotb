...
| **PERMASALAHAN**                                      | **SOLUSI**                                                              |
| ----------------------------------------------------------- | ----------------------------------------------------------------------------- |
| **100+ UMKM herbal Solo** terhambat di pasar informal | **Mini Factory:** First community-based shared CPOTB facility di Jateng |
| ❌ Tidak bisa akses CPOTB → Tidak bisa dapat izin BPOM     | ✅**4-in-1 Ekosistem:** Produksi + Pelatihan + Tourism + R&D            |
| ❌ Missing**Rp 220 triliun** peluang pasar            | **Investasi:** Rp 800 Juta (Pemkot Rp 300 Juta + CSR Rp 500 Juta)       |
...
**Keunggulan Penggerak Pertama** - Belum ada shared CPOTB facility di Jawa Tengah
...
## 🎯 PENTINGNYA MEMBANGUN PABRIK MINI / BUILDING FARMING

### Mengapa Fasilitas Ini Sangat Urgent dan Strategis?
...
**1. Menjembatani Kesenjangan Infrastruktur (Bridging the Gap)**
Saat ini, terjadi kesenjangan besar antara **potensi pasar Rp 220 Triliun** dengan **kapabilitas produksi UMKM**. UMKM memiliki semangat dan resep, namun tidak memiliki akses ke fasilitas produksi standar CPOTB (Cara Pembuatan Obat Tradisional yang Baik) yang mahal.

* **Tanpa Mini Factory:** UMKM memproduksi di dapur rumah → Tidak higienis standar industri → Tidak lulus BPOM → Tidak bisa masuk pasar modern.
* **Dengan Mini Factory:** UMKM menyewa fasilitas standar CPOTB ("Toll Manufacturing") → Produk higienis & terstandar → Lulus BPOM → Ekspor & Retail Ready.

**2. Standarisasi & Keamanan Produk (Quality & Safety)**
Pasar global dan konsumen modern menuntut jaminan keamanan produk. Mini Factory menjamin bahwa setiap produk herbal yang keluar dari fasilitas ini telah melalui proses yang terkontrol suhunya, terjamin kebersihannya, dan terukur dosisnya. Ini mengubah citra jamu dari "minuman tradisional pinggir jalan" menjadi "produk kesehatan terstandar".

**3. Efisiensi Biaya & Daya Saing (Cost Efficiency)**
...
**4. Menciptakan Multiplier Effect Ekonomi**
Mini Factory ini adalah "mesin" penggerak ekonomi. Dengan beroperasinya pabrik ini:

* **Sektor Hulu (Pertanian) Tumbuh:** Permintaan bahan baku simplisia terstandar meningkat.
* **Sektor Hilir (Wisata/Jasa) Tumbuh:** Munculnya paket wisata wellness, jasa pengemasan, dan pemasaran digital.
* **Penyerapan Tenaga Kerja:** Menciptakan lapangan kerja baru bagi operator mesin, tenaga QC, dan manajemen operasional.

> **💡 KESIMPULAN:**
> **"Building Farming"** di sini bermakna membangun **hulu-ke-hilir pertanian herbal** yang bernilai tambah tinggi. Mini Factory adalah **kunci** (key enabler) yang mengubah komoditas mentah menjadi produk bernilai jual tinggi, membawa ekonomi Solo naik kelas.
...
**Ini adalah FIRST COMMUNITY-BASED SHARED FACILITY (Fasilitas Produksi Berbasis Komunitas) di Jawa Tengah.** Solusi ini memecahkan bottleneck terbesar: **AKSESIBILITAS.**
...
> **💡 INSIGHT KRITIS:**
> Solo memiliki **permintaan** (4.4 juta visitors), **pasokan** (100+ UMKM), dan **government backing** (pilot project status).
...
> **💡 INSIGHT KRITIS:**
> Dengan **struktur pendanaan sinergis (Pemkot Rp 300 Juta + CSR Rp 500 Juta)**, investasi terbagi secara beban yang wajar.
> **Primary Funding:** Pemkot Rp 300 Juta + CSR Rp 500 Juta = **Rp 800 Juta (100% cash)**

---

## 💎 SOLUSI KAMI: 4-IN-1 INTEGRATED ECOSYSTEM
...
- **7,500 kg/tahun** simplisia processed (Ramp-up Tahun Ops 2027)
...
- **Viewing Gallery:** Wisatawan dapat melihat proses produksi CPOTB secara langsung
- **Sensory Garden:** Kebun percontohan tanaman obat dengan 20+ species (kunyit, jahe, temulawak, lengkuas, sereh)
- **Jamu Tasting:** Workshop membuat jamu tradisional
- **Photo Spots:** Instagram-worthy corners dengan batik Jawa + tanaman obat

**Target:**

- **1,500 visitors/tahun** (Ramp-up Target Ops 2027)
...
- **Formulasi produk** baru (herbal blends, dosage optimization)
- **Stability studies** untuk shelf-life testing
- **BPOM registration support** (dokumentasi, lab tests)
- **Co-creation workshops** dengan UNS researchers
...
![Facility Interior Produksi](images/facility_interior_production_1770089936073.png)

**Zona Produksi CPOTB-Compliant:**

- **Raw Material Storage:** Controlled temperature & humidity
- **Processing Area:** Grinding, extraction, mixing stations
- **Filling & Packaging:** Capsule filling, sachet sealing machines
- **QC Laboratory:** Microscopes, testing equipment, documentation area
- **Finished Goods Storage:** Quarantine & release area
...
- 1 Facility Manager
- 2 Production Supervisors (CPOTB-certified)
- 4 Production Operators
- 2 QC Analysts
- 2 BNSP Trainers/Assessors
- 2 Wellness Tourism Guides
- 1 Admin & Finance
- 1 Marketing & Partnership

**Indirect Jobs (300+ positions):**

- UMKM owners & staff (100 UMKM × 3 staff avg = 300 jobs)
- Packaging suppliers
- Delivery & logistics
...
- **Bali:** Wellness tourism (spa, yoga, retreat) ✅
- **Yogyakarta:** Cultural tourism + wellness ✅
- **Solo:** **Wellness MANUFACTURING hub** 🚀 ← **UNIQUE POSITIONING**

**Differentiation:**

- Bali & Yogya fokus pada **consumption** (spa, retreat)
- Solo fokus pada **production** (manufacturing, training, R&D)
- **Complementary, not competitive**

**National & International Recognition:**

- **First CPOTB shared facility** di Jawa Tengah
- **Benchmark** untuk kota lain yang ingin replicate
- **Media coverage:** National TV, wellness magazines, international wellness conferences
- **Awards potential:** CSR awards, tourism innovation awards, UMKM empowerment awards
...
### Milestone Implementasi 2026: Tahun Pondasi (Foundation Year)
...
| :---------------- | :-------------------------------------------------------------------- | :----------------------------------------------------------------------------- | :----------------------------- |
| **Q1 2026** | **DED & Perizinan**`<br>`(Finalisasi desain, Tender)          | **Stakeholder Engagement**`<br>`(MoU Pemkot, BPOM, Mitra CSR)          | Izin Prinsip, Komitmen Mitra   |
| **Q2 2026** | **Tender & Persiapan Lahan**`<br>`(Pemenang tender, Cleaning) | **Rekrutmen Tim Inti**`<br>`(Facility Manager, QC Lead)                | Kontraktor Terpilih, Core Team |
| **Q3 2026** | **Konstruksi Struktur**`<br>`(Pondasi, Dinding, Atap)         | **Kurasi & MoU UMKM**`<br>`(Seleksi 30 UMKM Early Bird)                | Bangunan Berdiri, Kontrak UMKM |
| **Q4 2026** | **Finishing & Instalasi Mesin**`<br>`(Epoxy, HVAC, Equipment) | **Bimbingan Teknis Pra-Operasi**`<br>`(SOP Produksi & Pelatihan Admin) | Fasilitas Siap, SDM Siap       |

> **Catatan:** Revenue komersial diproyeksikan mulai masuk pada **Tahun Operasional 1 (2027)**.

#### KPI (Key Performance Indicators) - Target Fase Operasional
...
- ✅ **Production logs:** Daily tracking of kg processed, UMKM served, equipment utilization
- ✅ **Financial system:** Monthly P&L, cash flow, balance sheet (software: accurate/zahir)
- ✅ **Training database:** Participant records, certificates issued, satisfaction surveys
- ✅ **Tourism ticketing:** Visitor count, demographics, spending patterns
...
- **Pendapatan Ops 2027:** **Rp 75 juta**

#### 4️⃣ **Product Development & R&D**

- **Services:** Formulasi produk dasar & konsultasi
- **Target:** 5-10 project awal
- **Pendapatan Ops 2027:** **Rp 30 juta**

**Total Pendapatan (Ops 2027):** **Rp 480 juta** (Ramp-up Phase)
**Total Laba Bersih (Ops 2027):** **(Break-even / Laba Kecil)**
**Focus:** Operational Stability & Market Penetration (Pertumbuhan Laba in Tahun Ops 2028)
...
### ⚠️ RISK MITIGATION & SCENARIO PLANNING
...
- ✅ **Success stories:** Showcase 5-10 UMKM pertama yang berhasil dapat izin BPOM (social proof)
...
- ✅ **Contingency:** Jika delay > 6 bulan, fokus ke training & tourism revenue dulu (~Rp 255M/year)
...
- ✅ **Backup plan:** Partnership dengan pabrik besar (Deltomed/Mitra Lain) untuk emergency production
- ✅ **Preventive maintenance:** Monthly checkup schedule, trained operators
...
- ✅ **Pemkot commit first:** Rp 300M dari Pemkot HARUS secure dulu sebelum CSR
- ✅ **Phased approach:**
  - **Phase 1A (Rp 300M Pemkot only):** Core production facility (Building/Renovation basic)
  - **Phase 1B (+ Rp 500M CSR):** Full Equipment (extraction, capsule filling) + Lab
- ✅ **Alternative funding:** Bank loan atau support pemerintah pusat (Kemenperin)
- ✅ **Multiple CSR targets:** Menargetkan beberapa perusahaan farmasi Tbk & multinational corps
...
> Bahkan dalam **worst case** (60 UMKM, delay 6 bulan, CSR parsial), Mini Factory tetap **viable**.
> **Ini bukan "blind optimism"—ini adalah calculated risk dengan downside protection.**

---

## 💼 INVESTASI & PENDANAAN (Rp 800 Juta)
...
![Funding Structure](images/funding_structure_rp800m.png)

</div>

---

### CSR Partnerships (Target: Rp 500 Juta)

**Status:** Aktif discussion dengan beberapa potential mitra strategis.

#### 1️⃣ **Perusahaan Farmasi Nasional (Tbk)**

**Kategori:** Perusahaan Jamu & Farmasi Besar
**Potential Contribution:**

- **Mesin & Peralatan Utama** (Processing, Grinding, Extraction)
- **Nilai:** ~Rp 300-400 Juta

#### 2️⃣ **Holding BUMN / Mitra Korporasi Lain**

**Kategori:** BUMN / Private Sector
**Potential Contribution:**

- **Peralatan Lab & Penunjang**
- **Nilai:** ~Rp 100-200 Juta

**Rationale:**
Program ini sejalan dengan mandat CSR untuk pemberdayaan UMKM dan local content (TKDN). Dengan branding "Solo Wellness City", partisipasi CSR memberikan PR value yang tinggi.
...
- ✅ **Tax benefits:** CSR contributions dapat diklaim sebagai pengurang penghasilan kena pajak
...
### Partnership Akademik: UNS (Universitas Sebelas Maret)

**Kolaborasi:**

- **Lab facilities** untuk R&D dan stability studies
- **Dosen expertise** untuk formulasi produk dan quality control
- **Student internships** untuk operational support
- **Research projects** untuk product innovation
...
## 🏛️ PERMOHONAN DUKUNGAN & PENUTUP

### Pentingnya Pemkot Surakarta menyetujui

Kami memohon dukungan Pemkot Surakarta untuk 3 hal strategis:

1. **Menyetujui investasi Rp 300 Juta** (Pembangunan Gudang/Renovasi)
2. **Mengalokasikan lahan** di Solo Technopark
3. **Mendukung partnership** dengan UNS & Mitra CSR

**Dengan langkah ini, Solo akan mendapatkan:**
🏆 **Fasilitas CPOTB Pertama** di Jateng
- [Indonesia Senang - WIW 2025 Dimulai di Solo-Jogja](https://indonesiasenang.com/wonderful-indonesia-wellness-2025-dimulai-di-solo-jogja/)

**PAD Pariwisata Rp 60.837 Miliar:**

- [Jurnal Surakarta - Kontribusi PAD Pariwisata 2022-2023](https://jurnal.surakarta.go.id/index.php/jbs/article/download/84/101/419)

---

## 3️⃣ DUKUNGAN PEMERINTAH

**Kemenperin IKM Program:**

- [Kemenperin - Program IKM OT](https://ikm.kemenperin.go.id)
- [Kemenperin - Industri Obat Bahan Alam](https://www.stabilitas.id/kemenperin-dorong-industri-obat-bahan-alam-ekspor-hingga-usd-639-juta/)

**Solo Technopark:**

- [Solo Technopark Official Website](https://solotechnopark.id)
- [Solo Technopark - Incubator Program](https://incubator.solotechnopark.id)
- [Solo Technopark - Events &amp; Beasiswa](https://solotechnopark.id/events)

**BPOM SIPEMANDU:**

- [BPOM - Portal UMKM](https://www.pom.go.id/umkm)
- [BPOM - PerBPOM No. 11/2025 CPOB](https://peraturan.bpk.go.id/Download/381648/peraturan-bpom-no-11-tahun-2025.pdf)
- [BPOM - PerBPOM No. 10/2024 Labeling](https://standar-otskk.pom.go.id/berita/perbpom-no-10-tahun-2024)
- [BPOM - Regulasi OTSKK](https://standar-otskk.pom.go.id/regulasi)

**BPUM Solo (Dinkop UKM):**

- [Dinkop UKM Surakarta](https://dinkop.surakarta.go.id)

**Kemenkop LPDB:**

- [Kemenkop - LPDB KUMKM](https://smesco.kemenkopukm.go.id)
- [Kemenkop Official Website](https://kemenkop.go.id)

---

## 4️⃣ CSR PARTNERSHIPS

**PT Sido Muncul - PROAKTIF:**

- [Sido Muncul Official Website](https://sidomuncul.co.id)
- [Sido Muncul - CSR PROAKTIF Program](https://www.pom.go.id/berita/bpom-ciptakan-sinergitas-bangun-kemandirian-umkm-obat-tradisional-indonesia)
- Contact: corporate@sidomuncul.co.id | (024) 866 9255

**PT Deltomed Laboratories:**

- [Deltomed Official Website](https://deltomed.com)
...
## 5️⃣ SUPPLIER & EQUIPMENT PRICING

**Verified Supplier Quotes:**

- [Gama Mesin - Mesin Ekstrak Herbal](https://www.gama-mesin.com/mesin-ekstrak-herbal)
- [PT Margamas Citratama](https://www.margamascitratama.com)
- [Wijayamas Teknindo - Mesin Penggiling](https://www.wijayamasteknindo.com/product/mesin-penggiling-ramuan-p471464.aspx)
- [Toko Jaya Mesin - Ribbon Mixer 50kg](https://www.tokojayamesin.com/product/mesin-ribbon-mixer-kapasitas-50-kg-p1439534.aspx)
- [Tokopedia - Mesin Filling Sachet](https://www.tokopedia.com/find/mesin-filling-sachet)
- [Royal Mesin - Mesin Packing Sachet](https://royalmesin.com/mesin-packing-sachet/)

**BMD Training Centre - CPOTB Training Pricing:**

- [BMD Training Centre](https://bikinpabrik.id/wp-content/uploads/2020/09/Materi-Bimtek-UMKM-New-Starter_Sistem-dan-Tata-Cara-Registrasi-OT-0708.pdf)

---

## 6️⃣ BNSP CERTIFICATION

**BNSP Official:**

- [BNSP Official Website](https://bnsp.go.id)
- [BNSP - LSP Directory](https://bnsp.go.id/lsp)
- [BNSP - Skema Sertifikasi](https://bnsp.go.id/skema-sertifikasi)

**LSP Certified Herbalist:**

- [Aimtraice - Certified Herbalist Batch 32](https://aimtraice.id/events/sertifikasiprofesibnspricertifiedherbalistbatch32)
