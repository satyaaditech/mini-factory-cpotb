...
Indonesia memiliki pasar obat tradisional dan herbal senilai **USD 13.7 miliar** (≈ Rp 220 triliun) dengan pertumbuhan **7.1% per tahun** [Custom Market Insights, 2024]. Solo, sebagai **pilot project nasional wellness tourism** [Kemenparekraf, 2024] dengan **4.4 juta pengunjung tahun 2024** [Dinas Pariwisata Surakarta, 2024], memiliki potensi besar namun menghadapi kendala kritis: **tidak ada fasilitas produksi bersama bersertifikat CPOTB** untuk memberdayakan 100+ UMKM herbal lokal [Perplexity Pro, 2026].
...
**Dukungan Pemerintah Terverifikasi:** Rp 200-400 juta [Kemenperin; Solo Technopark; BPUM; BPOM, 2024-2026]
...
- **72.62% masyarakat Jawa** konsumen aktif jamu [Kemenkes Ristoja, 2024]
...
- **1.305 juta pengunjung** Q1 2025 [Dinas Pariwisata Surakarta, 2025]
- **5,733 wisatawan mancanegara** + **1.299.480 domestik** (Jan-Mar 2025) [Dinas Pariwisata Surakarta, 2025]

**Wonderful Indonesia Wellness 2025:**
- Event diadakan di Solo (November 2025) [Kemenparekraf, 2025]
- Target: 5,000 wellness visitors [Kemenparekraf, 2025]
- Actual: 3,700+ visitors [Kemenparekraf, 2025]
- **Transaksi UMKM: Rp 8.5-9 miliar** [Kemenparekraf, 2025]
...
- **Aplikasi:** ikm.kemenperin.go.id [Verified Feb 2026]
- **Eligibility:** IKM OT terdaftar, potensi naik kelas [Kemenperin]
...
- **Dukungan:** 
  ...
  - Program inkubasi & pra-inkubasi [Solo Technopark]
- **Nilai Potensial:** **Rp 10-50 juta** grants + free training [Based on historical data]
- **Aplikasi:** solotechnopark.id/events, incubator.solotechnopark.id
- **Contact:** info@solotechnopark.id, (024) 760 0888 [Verified]
- **Status:** ✅ Program aktif, verified [Feb 2026]

#### 3️⃣ **BPUM Solo - Bantuan Produktif Usaha Mikro**
- **Dukungan:** Rp 1.2 juta per UMKM [Dinkop UKM Surakarta, 2024-2025]
- **Nilai Potensial:** **Rp 120 juta** (100 PARESO UMKM × Rp 1.2M) [Calculated]
- **Aplikasi:** Dinkop UKM Surakarta (annual, typically April)
- **Eligibility:** Solo KTP, NIB/SKDU, no KUR/ASN [Dinkop UKM]
- **Status:** ✅ Program rutin, verified

#### 4️⃣ **BPOM - SIPEMANDU (Sistem Pendampingan UMKM)**
- **Dukungan:** 
  - Mentoring GRATIS perizinan & CPOTB [BPOM, 2025]
  - Fasilitator training [BPOM, 2025]
  - CPOTB Bertahap guidance [PerBPOM No. 11/2025]
- **Nilai Potensial:** **Rp 10-20 juta** (consulting cost savings) [Estimated]
...
- **Nilai Potensial:** **Rp 50-500 juta** (loan, bukan grant) [LPDB range]
...
**Track Record:**
- ✅ **Ratusan UMKM** telah didampingi [Sido Muncul CSR Report]
- ✅ **3x CSR Award Jateng** (2022, 2023, 2024) [Sido Muncul]
- ✅ **BNSP Anugerah PROAKTIF 2025** dari BPOM [BPOM, 2025]
- ✅ Success stories "naik kelas" UMKM [Sido Muncul]

**Dukungan yang Dapat Diberikan:**
- Training & mentoring (BUKAN direct funding) [Sido Muncul CSR model]
- Literatur tanaman obat (kunyit, temulawak, dll) [Sido Muncul]
- Pendampingan BPOM registration & perizinan [PROAKTIF program]
- Production guidance & best practices [Sido Muncul]
...
```mermaid
graph TD
    A[Pemkot Solo<br/>Owner/Investor] --> B[Facility Manager]
    B --> C[Production Manager]
    B --> D[QC Manager]
    B --> E[Tourism & Training Manager]
    B --> F[Admin & Finance]
    
    C --> C1[2 Production Staff]
    D --> D1[1 QC Analyst]
    E --> E1[2 Trainers/Guides]
    F --> F1[1 Admin Staff]
    
    G[Advisory Board] -.-> B
    G --> G1[UNS Representative]
    G --> G2[PARESO Representative]
    G --> G3[Solo Technopark]
    G --> G4[BPOM Consultant]
...
|------|------------|--------|---------------------|
| **Budget Overrun** | Medium | High | - Phased equipment procurement<br/>- Government support leverage (Rp 200-400M)<br/>- Contingency 10% built-in |
| **Slow UMKM Adoption** | Low | Medium | - PARESO commitment (100 UMKM ready)<br/>- Free pilot program<br/>- BPOM registration support |
| **Tourism Lower Than Expected** | Medium | Low | - Conservative projection (3,000 vs 4.4M potential)<br/>- Hotel partnerships<br/>- WIW event integration |
| **CPOTB Audit Failure** | Low | High | - Hire BPOM consultant from day 1<br/>- Pre-audit internal checks<br/>- SIPEMANDU mentoring |
| **Equipment Breakdown** | Medium | Medium | - Preventive maintenance SOP<br/>- Vendor warranty & support<br/>- Spare parts inventory |
| **Competition Emerges** | Low | Medium | - First mover advantage (2-3 years lead)<br/>- Strong partnerships (UNS, PARESO)<br/>- Continuous innovation |
