...
**VISI:** Menjadikan Solo sebagai "Indonesia's Wellness Manufacturing Hub" melalui fasilitas produksi bersama standar CPOTB pertama di Jawa Tengah.

**THE OPPORTUNITY:**

![Market Size](images/market_size_infographic_1770089804893.png)
...
*   **Masalah (The Gap):** 100+ UMKM herbal Solo terhambat di pasar informal karena tidak memiliki fasilitas produksi standar CPOTB, sehingga tidak bisa mendapatkan izin BPOM.
...
*   **Dampak Ekonomi:**
    *   Memberdayakan **100 UMKM** naik diskelas (bisa masuk pasar modern).
...
| :--- | :--- |
| **Pabrik Besar (IOT/UKOT)** | **High MOQ (Minimal Order Tinggi)**, tidak menerima produksi skala kecil UMKM. |
...
![CPOTB Production Flow](images/cpotb_production_flow_infographic_1770194424740.png)
Fasilitas "Toll Manufacturing" (Maklon) dimana UMKM menyewa mesin dan ruang produksi terstandar.
*   **Kapasitas:** Melayani hingga 100 UMKM secara bergantian.
*   **Output:** 7,500 kg simplisia/tahun (Fase Ramp-up).
*   **Layanan:** Grinding, Ekstraksi, Mixing, Pengisian Kapsul, Packaging Sachet.
...
*   **Program:** Certified Herbalist, Pengolah Herbal, QC Officer.
*   **Target:** 200 peserta sertifikasi per tahun.
*   **Mitra:** LSP terkait dan Dinas Tenaga Kerja.
...
Pusat pengembangan produk bekerjasama dengan Akademisi (UNS).
*   **Layanan:** Formulasi ulang resep, uji stabilitas, perbaikan kemasan.
*   **Tujuan:** Meningkatkan nilai jual dan daya simpan produk UMKM.

---

## 4. DESAIN & SPESIFIKASI TEKNIS

### 4.1. Lokasi & Bangunan

![Facility Exterior](images/facility_exterior_main.jpg)
...
### 4.2. Layout Zoning (Standar CPOTB)

![Facility Layout](images/floor_plan_complete_facilities_1770186132944.png)
1.  **Grey Area (Gudang):** Penyimpanan bahan baku & kemasan.
2.  **White Area (Produksi):** Ruang terkontrol suhu & kelembaban, lantai epoxy, dinding mudah dibersihkan.
...
### 5.2. Rincian Penggunaan Dana

**A. Dana Pemkot (Rp 300 Juta)**
Fokus: Menyiapkan "Rumah" yang layak dan sesuai standar BPOM.
1.  **Renovasi Sipil (Rp 200 Juta):** Penyekatan ruang (partisi cleanroom), pemasangan lantai epoxy, plafon gypsum dust-free, pengecatan washable paint, perbaikan atap.
2.  **Utilitas & MEP (Rp 100 Juta):** Instalasi HVAC (AC & Exhaust Fan dengan filter), instalasi air bersih standar produksi, instalasi listrik industri, sistem penerangan LED, wastafel cuci tangan higienis.
...
## 6. PROYEKSI FINANSIAL & DAMPAK

### 6.1. Model Pendapatan (Revenue Stream)

![Revenue Model](images/revenue_model_realistic.png)
...
### 6.2. Analisis Keuntungan (Profitability)
