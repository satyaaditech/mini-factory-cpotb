...
```mermaid
graph TD
    A[Mini Factory Rempah] --> B[Sumber Dana]
    A --> C[Pelaku Operasional]
    A --> D[Edukasi & R&D]
    A --> E[Beneficiary]
    
    B --> B1[Pemkot Solo]
    B --> B2[CSR Sido Muncul]
    B --> B3[CSR BUMN]
    
    C --> C1[RBS - UMKM Utama]
    C --> C2[PARESO - 100 UMKM]
    
    D --> D1[Dosen UNS]
    D --> D2[Lab UNS]
    
    E --> E1[UMKM - Produksi Terstandar]
    E --> E2[Peserta Workshop - Sertifikat]
    E --> E3[UNS - Pengabdian & Riset]
    E --> E4[Pemkot - Wellness Tourism]
    E --> E5[Masyarakat - Edukasi Herbal]
```
...
```mermaid
gantt
    title Roadmap Sertifikasi BNSP Mini Factory
    dateFormat  YYYY-MM
    section Persiapan
    Pembentukan LSP (Lembaga Sertifikasi Profesi)    :2026-03, 3M
    Rekrutmen Asesor BNSP                             :2026-04, 2M
    Penyusunan Materi & SOP                           :2026-05, 2M
    section Lisensi
    Pengajuan Lisensi LSP ke BNSP                     :2026-06, 2M
    Audit & Approval BNSP                             :2026-08, 1M
    section Operasional
    Soft Launch - Pelatihan Pilot                     :2026-09, 1M
    Grand Launch - Full Operation                     :2026-10, 1M
```
...
```mermaid
journey
    title Wisatawan Wellness Tourism Experience
    section Arrival
      Parkir & Welcome: 5: Visitor
      Lihat Kebun Percontohan: 8: Visitor
      Photo di Sensory Garden: 9: Visitor
    section Education
      Presentasi di Aula: 7: Visitor
      Viewing Window - Lihat Produksi: 9: Visitor
      Interactive Exhibition: 8: Visitor
    section Experience
      Hands-on Workshop: 10: Visitor
      Tasting Jamu/Herbal Tea: 9: Visitor
    section Closing
      Shopping Produk Retail: 7: Visitor
      Feedback & Certificate: 8: Visitor
```
